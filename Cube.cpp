...
{
	//前
	{{-0.5f, 0.5f,-0.5f},{0.0f,0.0f,-1.0f},{1.0f,0.0f,0.0f,CUBE_ALPHA}, {0.0f, 0.0f}},
	{{ 0.5f,-0.5f,-0.5f},{0.0f,0.0f,-1.0f},{1.0f,0.0f,0.0f,CUBE_ALPHA}, {1.0f, 1.0f}},
	{{-0.5f,-0.5f,-0.5f},{0.0f,0.0f,-1.0f},{1.0f,0.0f,0.0f,CUBE_ALPHA}, {0.0f, 1.0f}},
	{{ 0.5f, 0.5f,-0.5f},{0.0f,0.0f,-1.0f},{1.0f,0.0f,0.0f,CUBE_ALPHA}, {1.0f, 0.0f}},
	//右
	...
	//上	
	{{-0.5f, 0.5f, 0.5f},{0.0f,1.0f,0.0f},{0.5f,0.3f,0.0f,CUBE_ALPHA}, {0.0f, 0.0f}},
	{{ 0.5f, 0.5f,-0.5f},{0.0f,1.0f,0.0f},{0.5f,0.3f,0.0f,CUBE_ALPHA}, {1.0f, 1.0f}},
	{{-0.5f, 0.5f,-0.5f},{0.0f,1.0f,0.0f},{0.5f,0.3f,0.0f,CUBE_ALPHA}, {0.0f, 1.0f}},
	{{ 0.5f, 0.5f, 0.5f},{0.0f,1.0f,0.0f},{0.5f,0.3f,0.0f,CUBE_ALPHA}, {1.0f, 0.0f}},
	//左
	{{-0.5f, 0.5f, 0.5f},{-1.0f,0.0f,0.0f},{1.0f,1.0f,0.2f,CUBE_ALPHA}, {0.0f, 0.0f}},
	{{-0.5f,-0.5f,-0.5f},{-1.0f,0.0f,0.0f},{1.0f,1.0f,0.2f,CUBE_ALPHA}, {1.0f, 1.0f}},
	{{-0.5f,-0.5f, 0.5f},{-1.0f,0.0f,0.0f},{1.0f,1.0f,0.2f,CUBE_ALPHA}, {0.0f, 1.0f}},
	{{-0.5f, 0.5f,-0.5f},{-1.0f,0.0f,0.0f},{1.0f,1.0f,0.2f,CUBE_ALPHA}, {1.0f, 0.0f}},
	//後
	{{ 0.5f, 0.5f, 0.5f},{0.0f,0.0f,1.0f}, {1.0f,0.0f,1.0f,CUBE_ALPHA}, {0.0f, 0.0f}},
	{{-0.5f,-0.5f, 0.5f},{0.0f,0.0f,1.0f}, {1.0f,0.0f,1.0f,CUBE_ALPHA}, {1.0f, 1.0f}},
	{{ 0.5f,-0.5f, 0.5f},{0.0f,0.0f,1.0f}, {1.0f,0.0f,1.0f,CUBE_ALPHA}, {0.0f, 1.0f}},
	{{-0.5f, 0.5f, 0.5f},{0.0f,0.0f,1.0f}, {1.0f,0.0f,1.0f,CUBE_ALPHA}, {1.0f, 0.0f}},
	//下
	{{-0.5f,-0.5f,-0.5f},{0.0f,-1.0f,0.0f},{1.0f,1.0f,1.0f,CUBE_ALPHA}, {0.0f, 0.0f}},
